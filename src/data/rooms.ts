...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    client: 'Pacientes',
    img: '/images/program-glp1.jpg',
    tagline: 'Revisión clínica de seguimiento para pacientes ya en tratamiento.',
    description: [
      'Consulta de seguimiento para pacientes que ya iniciaron tratamiento con GLP-1. Incluye revisión de evolución, ajuste de dosis si procede, evaluación de tolerancia y resolución de dudas clínicas.',
      'Indicada para mantener el tratamiento con seguridad y eficacia. Permite ajustar pauta según respuesta clínica y prevenir efectos adversos.',
    ],
    features: [
      'Revisión clínica con Dr. Martínez Escobar',
      'Ajuste de dosis si procede',
      'Evaluación de tolerancia y efectos',
      'Renovación de prescripción',
      'WhatsApp directo para preguntas',
      'Plan de seguimiento personalizado',
    ],
    price: '79€',
    priceNote: 'visita seguimiento',
    sqm: 'Seguimiento',
    occupancy: '1 paciente',
    bed: 'Presencial / Online',
  },

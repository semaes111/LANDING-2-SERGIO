...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    description: [
      'La consulta médica inicial de 45 minutos con el Dr. Sergio Martínez Escobar incluye anamnesis completa, evaluación de candidatura a tratamiento con Semaglutida (Wegovy) o Tirzepatida (Mounjaro), y prescripción individualizada si procede.',
    ...
    features: [
      'Consulta médica 45 min con Dr. Martínez Escobar',
  ...
  },
  {
    ...
    features: [
      'Revisión médica mensual 30 min',
